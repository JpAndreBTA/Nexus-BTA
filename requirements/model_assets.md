...
- WAN 2.2 Motion Capture keeps DWPose/ViTPose/LightX2V as optional dependency assets, but generation still requires a compatible high/low WAN Fun-Control or Animate motion-control model pair. LightX2V and other LoRAs can reduce steps or influence motion/style; they do not replace a motion-control checkpoint route.
