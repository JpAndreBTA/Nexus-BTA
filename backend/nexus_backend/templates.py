...
DEFAULT_MODEL_TEMPLATES: dict[str, dict[str, Any]] = {
    ...
    "Music3": {
        ...
        "type": "audio",
        "model_folder": "./models/diffusion_models/music3",
        "native_size": [1, 1],
        "sampler": "euler",
        "scheduler": "simple",
        "steps": 30,
        "cfg": 1.7,
        "supports": ["text_to_music", "caption", "lyrics", "long_form_5m", "native_audio", "tiled_decode", "rtx_3060_local", "rtx_5090"],
        "unsupported": ["image_reference", "video", "controlnet", "lora"],
        "workflow_hint": "music3",
    },
    "Anima": {
        "label": "ANIMA",
        "family": "anima",
